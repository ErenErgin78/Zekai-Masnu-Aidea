...
async def get_automatic_coordinates():
    """
    Kullanıcının IP adresinden otomatik konum tespiti yapar.
    """
    print("🌐 Otomatik konum tespiti yapılıyor...")
    
    try:
        # IP adresinden konum tespiti için API
        async with httpx.AsyncClient() as client:
            # Ücretsiz IP konum API'si
            ...
            if response.status_code == 200:
                ...
                if location_data.get("status") == "success":
                    ...
                    print(f"✅ Konum tespit edildi: {city}, {country}")
                    print(f"📍 Koordinatlar: Boylam={lon}, Enlem={lat}")
                    return lon, lat
                else:
                    print("❌ Konum tespit edilemedi.")
                    return None, None
            else:
                print("❌ Konum servisine erişilemedi.")
                return None, None
...
async def main():
    ...
    print("\n📍 Özellikler:")
    print("   - 🌐 Otomatik konum tespiti (IP adresinizden)")
    ...
    while True:
        try:
            ...
            print("=" * 50)
            print("1. 🌐 Otomatik Konum Tespiti")
            ...
            if choice == '3' or choice.lower() in ['çıkış', 'exit', 'quit']:
                ...
                location_method = "Otomatik konum tespiti (IP adresinizden)"
                ...
                # ✅ DOĞRU: Otomatik analiz fonksiyonunu kullan
...
if __name__ == "__main__":
    ...
    print("Soil API'yi başlatmak için: python -m uvicorn main:app --reload")
    print("\n⚠️  NOT: Otomatik konum tespiti için internet bağlantısı gereklidir.")
