...
def load_and_clean_data():
    """Veriyi yükler ve temizler, gerekli objeleri döndürür"""
    ...
    # Scaler'ı kaydet (model eğitimi için)
...
if __name__ == "__main__":
    ...
    print("Kullanıma hazır objeler: df, X_train, X_test, y_train, y_test, X_train_scaled, X_test_scaled, scaler")